                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div>
                                    ...
                                    <a href="{{ route('dashboard') }}" class="btn btn-primary">Ir al panel de
                                        administrador</a>
                                    ...
                                    @if (session('user'))
                                        <x-info-cliente :name="session('user')['first_name']" :last-name="session('user')['last_name']" :photo="session('user')['photo']" />
                                    @else
